...
class UserAccount
{
    ...
    public function loginAccount($username, $password)
    {
        ...
        if ($stmt->num_rows > 0) {
            ...
            if ($_SESSION['user_profile'] == 'Cafe Manager') {
                header('location: ../../Boundary/CafeManager/cafeManager.php'); //Cafe Manager
            } elseif ($_SESSION['user_profile'] == 'Cafe Owner') {
                header('location: ../../Boundary/CafeOwner/cafeOwner.php'); // Cafe Owner
            } elseif ($_SESSION['user_profile'] == 'System Admin') {
                header('location: ../../Boundary/SystemAdmin/userProfile.php'); //System Admin
            } elseif ($_SESSION['user_profile'] == 'Cafe Staff') {
                header('location: ../../Boundary/CafeStaff/cafeStaff.php');// Cafe Staff
            } else {
                return $user;
            }
            return true;
